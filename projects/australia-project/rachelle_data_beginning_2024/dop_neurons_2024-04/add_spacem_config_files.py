...
project_dir = Path("/scratch/bailoni/datasets/australia_project/data_2024/neurons_april_24/")

# Load dataframe with dataset IDs:
df = pd.read_csv(project_dir / "all_neurons.csv")
SLIDE_KEY = "slide"

dir_default_config_files = project_dir / "default_configs"
root_spacem_folder = project_dir / "spacem_v1"
...
for slide_id in [
    ...
    spacem_project_dir = root_spacem_folder / f"slide_{slide_id}"
