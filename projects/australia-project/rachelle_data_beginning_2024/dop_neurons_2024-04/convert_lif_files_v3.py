...
if __name__ == "__main__":
    ...
    convert_lif_australia_file_to_ngff_zarr(
        input_lif_file=Path("/scratch/bailoni/datasets/australia_project/new_data_feb_2024/05-april-24/20240213_DA neurons 11291 and 11574 d50 Cellbright green and hoechst_pre MSI.lif"),
        out_dir=Path("/scratch/bailoni/datasets/australia_project/new_data_feb_2024/05-april-24/ht-spacem"),
        write_images=True,
        create_csv=True,
    )
